...
let sliderSlider = new Swiper('.slider-science', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
let sliderSliderSc = new Swiper('.slider-sertificate__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.slider-sertificate .slider__prew',
		prevEl: '.slider-sertificate .slider__next',
	},
	breakpoints: {
		310: {
			slidesPerView: 1,
